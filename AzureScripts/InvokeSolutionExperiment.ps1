...
param (
	...
	[string] $solutionPath = "ILSpy",
	[string] $solutionName = "ILSpy",
	[int] $machines = 4,
	[string] $expID= "",
...
else
{
	...
	$resource = "http://localhost:49176/" 
	$drive = "C"
	$solutionPath = "\Users\Edgar\Projects\Test projects\" + $solutionPath
	#$solutionPath = "\Users\Edgar\Projects\Call-Graph-Builder\TestsSolutions\" + $solutionPath
}
$controler="api/Experiments"
